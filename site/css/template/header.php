<!DOCTYPE html>
<html lang="fr">
<?php require_once File::build_path(array("model", "ModelCategorie.php")); ?>
<head>
  <meta charset="utf-8">
...
<body>
  ...
  <header>
  	...
  	<!--Navbar-->
		<nav class="fixed-top scrolling-navbar navbar navbar-expand-lg navbar-dark light-green darken-3">
		  ...
		  <div class="collapse navbar-collapse" id="basicExampleNav">
		    ...
		    if(Session::is_admin()==false){
				echo '<a class="dropdown-item" href="#">Mes commandes</a>';
			}
			if(Session::is_admin()==true){
		          ...
		          <a class="dropdown-item" href="./?controller=facture">Facture</a>';
			}
